...
# Set this to your HuggingFace model ID after uploading
ASRIPA_MODEL_DIR="/app/models/fine_tuned_vit"
# TODO: Replace with your HuggingFace model ID after uploading
# Example: ASRIPA_MODEL_ID="your-username/asripa-emotion-detection"
ASRIPA_MODEL_ID="${ASRIPA_MODEL_ID:-}"
...
" || {
  ...
  echo "   Set ASRIPA_MODEL_ID environment variable in Render to enable"
fi
...
# Render free tier has limited memory, so we must be conservative
PORT="${PORT:-5000}"
